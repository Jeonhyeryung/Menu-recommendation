...
# 🏃🏃‍♂️ 프로젝트 팀 구성 및 역할
- **권수현**: 데이콘 식단 데이터 수집 및 전처리, 모델 서치, RNN 기반 모델 튜닝, 설문조사 데이터셋 전처리, 발표자료 제작
- **김채은**: 나이스 급식 식단 데이터 수집 및 전처리, 발표 
- **김형민**: 설문조사 포맷 제작, 데이터셋 태깅, 성능평가지표 수정 및 적용
- **손승진**: 프로젝트 리딩, 데이터셋 결측치 제거 및 태깅, GNN, AutoEncoder 기반 모델 튜닝
- **전혜령**: 아이디어 제시, 데이터 및 모델 서치, Transformer, AutoEncoder 기반 모델 튜닝, 성능평가지표 적용
